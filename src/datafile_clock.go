...
type DFReaderClock interface {
	...
	MessageArrived(message *DFMessage)
	RewindEvent()
	FindTimeBase(gps *GPS, firstMsStamp int64)
}
...
func (clock *DFReaderClockBase) MessageArrived(message *DFMessage) {
...
func (clock *DFReaderClockBase) FindTimeBase(gps *GPS, firstMsStamp int64) {
	// Implement this method based on your requirements
}

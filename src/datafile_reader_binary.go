...
func (d *DFReaderBinary) recvMsg() DFMessage {
	return *d.ParseNext()
}
...
func (reader *DFReaderBinary) ParseNext() *DFMessage {
    skipType := [3]byte{}
    skipStart := int64(0)
    var msgType byte
    for {
...
func (reader *DFReaderBinary) AddFormat(fmt *DFFormat) *DFFormat {
